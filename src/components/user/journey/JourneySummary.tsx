            ...
            <div className="event-inner">
                <div className="event-thumb">
                    ...
                    <div className="event-overlay">
                        <Link to="/user-touchpoints/touchpoint#"><i className="fa-solid fa-arrow-up-right-from-square"></i></Link>
                    </div>
                </div>
                <div className="event-desc">
                    <h2><Link to="/user-touchpoints/touchpoint#">{title}</Link></h2>
